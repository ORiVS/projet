...
<div class="row"> 
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered">
                ...
                <tbody>
                                        ...
                                        $sql = 'SELECT * FROM samuel.acolytes ORDER BY nom ASC'; //on formule notre requete
                                        foreach ($pdo->query($sql) as $row) { //on cree les lignes du tableau avec chaque valeur retournée
                                            ...
                                            echo '</td>';
                                            echo '<td>';
                                            echo '<a class="btn btn-success" href="update.php?id=' . $row['id'] . '">MODIFIER</a>';// un autre td pour le bouton d'update
                                            echo '</td>';
                                            echo'<td>';
    ...
    <a class="btn" href="novice.php">Voir la liste des Novices</a> <br>
    <a class="btn" href="acolyte.php">Voir la liste des Acolytes</a> <br>
    <a class="btn" href="porteben.php">Voir la liste des Porte Benitier</a> <br>
    <a class="btn" href="ceroferaire.php">Voir la liste des Ceroferaires</a> <br>
    <a class="btn" href="portecroix.php">Voir la liste des Porte Croix</a> <br>
    <a class="btn" href="naiculaire.php">Voir la liste des Naviculaires</a> <br>
    <a class="btn" href="#">Voir la liste des Turiféraires</a>
